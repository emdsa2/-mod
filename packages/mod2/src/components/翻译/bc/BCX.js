const translation = {
    ...
    "Cheat: Give yourself the mistress padlock and its key": "作弊：给自己女主人挂锁及其钥匙",
    "Cheat: Give yourself the pandora padlock and its key": "作弊：给自己潘多拉挂锁及其钥匙",
    ...
    "Cheat: Prevent random NPC events (kidnappings, ransoms, asylum, club slaves)":
        "作弊：防止随机 NPC 事件(绑架、赎金、收容所、俱乐部奴隶)",
    ...
    "Forbid the antiblind command": "禁止使用防盲指令",
    "Prevent usage of all activities": "禁止使用所有交互动作",
    "Forbid mainhall maid services": "禁止大厅女仆服务",
    "Forbid changing difficulty": "禁止改变难度",
    "Prevent whitelisting": "禁止增加白名单",
    "Forbid the action command": "禁止动作指令",
    ...
    "Garble whispers while gagged": "嘴巴被堵住时混淆私聊",
    "Block OOC chat while gagged": "嘴巴被堵住时阻止 OOC 聊天",
    "Block OOC chat": "阻止 OOC 聊天",
    "Doll talk": "玩偶言语",
    "Forbid saying certain words in chat": "禁止在聊天中说某些词",
    "Forbid saying certain words in emotes": "禁止在表情中说某些词",
    "Forbid talking openly": "禁止公开聊天",
    "Limit talking openly": "限制公开聊天",
    "Forbid using emotes": "禁止使用表情符号",
    "Limit using emotes": "限制使用表情符号",
    "Restrict sending whispers": "限制发送私信",
    "Restrict receiving whispers": "限制接收私信",
    "Restrict sending beep messages": "限制发送蜂鸣消息",
    "Restrict receiving beeps": "限制接收蜂鸣",
    "Order to greet club": "登录时自动发蜂鸣消息",
