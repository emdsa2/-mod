const translation = {
    ...
    "Improve the Name Mentioned notification in the original BC. Use keywords for mentioning names according to different roles. (Note: source code unavailable)":
        "改进BC原本提醒中的提到名字的规则.按照不同的身份配置提到名字的触发关键词.(注:源代码不可用)",
    ...
    "Addon that auto-translates the chat to the language you want. 130+ Languages available. Commands: /ttoggle to toggle the translator on and off. And /tlang":
        "将聊天自动翻译为您想要的语言的插件.有 130 多种语言可用.命令:/ttoggle 切换翻译器的开关./tlang ",
...
const htmlTags = [
    "#fusam-addon-manager-header > h1",
    "#fusam-addon-manager-body",
