...
const dialog = {
    CN: {
        ...
        ItemDevices充气式拘束袋_LuziSeto0: "SourceCharacter放掉了DestinationCharacter的拘束袋的气体",
        ItemDevices充气式拘束袋_LuziSeto1: "SourceCharacter将DestinationCharacter的拘束袋充满了气体",
        ItemDevices充气式拘束袋_LuziSetg0: "SourceCharacter移除了DestinationCharacter的呼吸器限制",
        ItemDevices充气式拘束袋_LuziSetg1: "SourceCharacter添加了DestinationCharacter的呼吸器限制",
        ItemDevices充气式拘束袋_LuziSett0: "SourceCharacter移除了DestinationCharacter的头套",
        ItemDevices充气式拘束袋_LuziSett1: "SourceCharacter添加了DestinationCharacter的头套",
    },
    EN: {
        ...
        ItemDevices充气式拘束袋_LuziSeto0: "SourceCharacter released the gas from DestinationCharacter's restraint bag",
        ItemDevices充气式拘束袋_LuziSeto1: "SourceCharacter filled DestinationCharacter's restraint bag with gas",
        ItemDevices充气式拘束袋_LuziSetg0: "SourceCharacter removed the breathing restriction from DestinationCharacter",
        ItemDevices充气式拘束袋_LuziSetg1: "SourceCharacter added a breathing restriction to DestinationCharacter",
        ItemDevices充气式拘束袋_LuziSett0: "SourceCharacter removed the hood from DestinationCharacter",
...
const dialog2 = {
    CN: {
        ...
        ItemArms充气式拘束袋_LuziSeto0: "SourceCharacter放掉了DestinationCharacter的拘束袋的气体",
        ItemArms充气式拘束袋_LuziSeto1: "SourceCharacter将DestinationCharacter的拘束袋充满了气体",
        ItemArms充气式拘束袋_LuziSetg0: "SourceCharacter移除了DestinationCharacter的呼吸器限制",
        ItemArms充气式拘束袋_LuziSetg1: "SourceCharacter添加了DestinationCharacter的呼吸器限制",
        ItemArms充气式拘束袋_LuziSett0: "SourceCharacter移除了DestinationCharacter的头套",
        ItemArms充气式拘束袋_LuziSett1: "SourceCharacter添加了DestinationCharacter的头套",
    },
    EN: {
        ...
        ItemArms充气式拘束袋_LuziSeto0: "SourceCharacter released the gas from DestinationCharacter's restraint bag",
        ItemArms充气式拘束袋_LuziSeto1: "SourceCharacter filled DestinationCharacter's restraint bag with gas",
