...
const dialog = {
    CN: {
        ...
        ItemPelvis淫纹_LuziSett0: "SourceCharacter将DestinationCharacter的淫纹设置为默认样式.",
        ItemPelvis淫纹_LuziSett1: "SourceCharacter将DestinationCharacter的淫纹设置为样式1.",
        ItemPelvis淫纹_LuziSett2: "SourceCharacter将DestinationCharacter的淫纹设置为样式2.",
        ItemPelvis淫纹_LuziSett3: "SourceCharacter将DestinationCharacter的淫纹设置为样式3.",
    ...
    EN: {
        ...
        ItemPelvis淫纹_LuziSett0: "SourceCharacter sets DestinationCharacter's Lust Pattern to the default style.",
        ItemPelvis淫纹_LuziSett1: "SourceCharacter sets DestinationCharacter's Lust Pattern to Style 1.",
        ItemPelvis淫纹_LuziSett2: "SourceCharacter sets DestinationCharacter's Lust Pattern to Style 2.",
        ItemPelvis淫纹_LuziSett3: "SourceCharacter sets DestinationCharacter's Lust Pattern to Style 3.",
