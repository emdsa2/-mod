...
const asset = {
    ...
    Layer: [
        ...
        { Name: "莉莉丝", AllowTypes: { f: 18 } },
        { Name: "空", AllowTypes: { f: 19 } },
        { Name: "空", AllowTypes: { f: 20 } },
        { Name: "空", AllowTypes: { f: 21 } },
        { Name: "空", AllowTypes: { f: 22 } },
        { Name: "空", AllowTypes: { f: 23 } },
        { Name: "空", AllowTypes: { f: 24 } },
        { Name: "空", AllowTypes: { f: 25 } },
        { Name: "空", AllowTypes: { f: 26 } },
    ],
};
