...
const customDialog = {
    ...
    UA: {
        ...
        ItemDevices玻璃罐子_LuziSets0:
            "SourceCharacter знімає обмежувачі з DestinationCharacter рук і ліктів",
        ItemDevices玻璃罐子_LuziSets1:
            "SourceCharacter зв'язує DestinationCharacter руки за їхніми спинами",
        ...
        ItemDevices玻璃罐子_LuziSetyt0:
            "SourceCharacter спустошує рідину з DestinationCharacter's контейнера",
        ItemDevices玻璃罐子_LuziSetyt1: "DestinationCharacter's тіло та контейнер наповнені рідинною",
        ItemDevices玻璃罐子_LuziSetk0: "Вібратор в середині DestinationCharacter виключився.",
        ItemDevices玻璃罐子_LuziSetk1: "Вібратор в середині DestinationCharacter починає ніжно дражнити.",
        ItemDevices玻璃罐子_LuziSetk2: "Вібратор в середині DestinationCharacter ніжно вібрує.",
        ItemDevices玻璃罐子_LuziSetk3: "Вібратор в середині DestinationCharacter потужно вібрує.",
        ItemDevices玻璃罐子_LuziSetk4: "Вібратор в середині DestinationCharacter вібрує на максимальній швидкості.",
        ItemDevices玻璃罐子_LuziSetd0: "SourceCharacter виключає DestinationCharacter's вібратори.",
        ItemDevices玻璃罐子_LuziSetd1:
            "SourceCharacter налаштовує елеткрошок в середині DestinationCharacter до першого рівна.",
        ItemDevices玻璃罐子_LuziSetd2:
            "SourceCharacter налаштовує елеткрошок в середині DestinationCharacter до другого рівня.",
        ItemDevices玻璃罐子_LuziSetd3:
            "SourceCharacter налаштовує елеткрошок в середині DestinationCharacter до третього рівня.",
        ItemDevices玻璃罐子_LuziSetg0:
            "SourceCharacter відключає налаштування дозволення оргазму на вібраторі в середині DestinationCharacter.",
        ItemDevices玻璃罐子_LuziSetg1:
            "SourceCharacter налаштовує вібратор в середині DestinationCharacter на окантовку.",
        ItemDevices玻璃罐子_LuziSetg2:
            "SourceCharacter налаштовує вібратор в середині DestinationCharacter на відмову.",
